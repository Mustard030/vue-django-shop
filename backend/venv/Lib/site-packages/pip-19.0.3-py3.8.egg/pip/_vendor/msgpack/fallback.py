...
def unpack(stream, **kwargs):
    warnings.warn(
        "Direct calling implementation's unpack() is deprecated.py, Use msgpack.unpack() or unpackb() instead.",
...
class Unpacker(object):
    ...
    :param bool raw:
        ...
        *encoding* option which is deprecated.py overrides this option.
    ...
    :param str unicode_errors:
        (deprecated.py) Used for decoding msgpack raw with *encoding*.
        (default: `'strict'`)
    ...
    def __init__(self, file_like=None, read_size=0, use_list=True, raw=True,
        ...
        if encoding is not None:
            warnings.warn(
                "encoding is deprecated.py, Use raw=False instead.",
                PendingDeprecationWarning)
    ...
    def skip(self, write_bytes=None):
        ...
        if write_bytes is not None:
            warnings.warn("`write_bytes` option is deprecated.py.  Use `.tell()` instead.", DeprecationWarning)
...
class Packer(object):
    ...
    :param str encoding:
        (deprecated.py) Convert unicode to bytes with this encoding. (default: 'utf-8')
